...
$query=mysql_query("SELECT articles.id,fk_student,topic,content,date,FirstName,image_name FROM articles,students WHERE students.id = fk_student AND articles.id='$art_id'");
