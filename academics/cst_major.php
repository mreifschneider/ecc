    ...
    color: #333;
									...
									<h1>Computer Science Teaching Major</h1>
							<p>
								The Computer Science Teaching Major is part of a	
								program leading to a Wisconsin initial educator license to 
								teach computer science at the early adolescence through 
...
$sql="SELECT courses.course_code, courses.course_name, courses.course_des, major_has_courses.type FROM courses, majors, major_has_courses WHERE  major_has_courses.fk_majors = majors.id AND major_has_courses.fk_courses = courses.id AND major_has_courses.fk_majors = 4 AND type= 'major'" ;
...
?>
			...
			?>
			<p>
								Two elective courses to be determined by the department.
							</p>
							<p>
